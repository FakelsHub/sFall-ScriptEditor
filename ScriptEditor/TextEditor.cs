            ...
            if (currentTab == tab) {
                if (tab.filepath != null) {
                    if (tab.parseInfo.parsed) {
                        ...
                        //currentTab.needsParse = true; // требуетс€ обновление
                    }
                } else {
...
#region Function Back/Forward
        ...
        // NoSave - Ќе сохран€ть следующее перемещение в историю.
        // SaveChange - »зменить следующее перемещение в текущей позиции истории.
        // Disabled - Ќе сохран€ть все последуюшие перемещени€ в историю (до €вного включени€ функции).
